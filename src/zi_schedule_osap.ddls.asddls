...
define view entity ZI_SCHEDULE_OSAP as select from zschedule_osap as Schedule
  association to parent ZI_COURSE_OSAP as _Course on $projection.CourseUuid = _Course.CourseUuid
{
